...
## 참고
- ADR-038(plan cross-LLM — mirror), ADR-044(discovery cross-LLM — mirror + Codex 자연어 비대칭 선례), ADR-052 D4(repair-milestone 소유), ADR-068(졸업), ADR-007(책임 경계), ADR-047 D3(Mutation Contract), Ning et al. 2026 (arXiv:2605.18747).
