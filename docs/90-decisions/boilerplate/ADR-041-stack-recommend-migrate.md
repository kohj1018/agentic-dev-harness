...
## 참고
- ADR-031(직접 지원 범위 — #amend-1로 Flutter 이관), ADR-059(Flutter 프로파일), ADR-006(단순성), ADR-040(researcher 그라운딩), ADR-025(외부 의존 권장).
