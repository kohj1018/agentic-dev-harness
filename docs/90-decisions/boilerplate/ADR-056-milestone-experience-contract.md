...
6. **렌더 증거 주입** — stabilize design-surface reviewer 입력에 §3-V 갤러리 경로·visual-qa 결과를 주입(ADR-027#amend-6) (현재 SSOT: ADR-073 D8), reviewer는 Read로 이미지 열람.
...
## 참고
- ADR-058(R2 원형·carve-out·실카피 라운드 배선 — ADR-049 supersede) (현재 SSOT: ADR-058), ADR-042(#amend-1 — §8-1 delta), ADR-007(#amend-5 — 입구 계약 예외 등재), ADR-027(#amend-3 UI 판정, #amend-5 §10 섹션, #amend-6 렌더 증거) (현재 SSOT: ADR-073), ADR-052(Playwright 선설치), ADR-068(item 6), ADR-048(browser MCP는 §3-P 탐색용 — §3-V는 MCP 불요), ADR-022, ADR-047 D3.
