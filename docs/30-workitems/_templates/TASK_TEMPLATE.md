...
- Architecture-Iface: <!-- 해당 스택 한정. 예: [ARCH ## 7-1 API](../../20-system/ARCHITECTURE_OVERVIEW.md#7-1-api-컨벤션) / [## 7-4 프론트](../../20-system/ARCHITECTURE_OVERVIEW.md#7-4-프론트-결정). 비해당 스택은 줄 자체 삭제 (placeholder 잔존 X). 정책: ADR-027. -->
