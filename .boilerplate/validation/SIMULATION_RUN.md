...
| ADR-004#amend-8 (a) 「쓰기 도구 보유 에이전트의 보고 0건 상한 도달」 | **발화 (2회)** | 반환은 있었으나 보고가 아니다 |
| ADR-004#amend-9 (a) 「상한 중단 + 산출물 파일 0건」 | **미발화** | 위와 같음 |
| ADR-004#amend-9 (b) 「골격만 쓰고 미검토 절반 초과」 | **미발화** | `미검토:` 0건 |
