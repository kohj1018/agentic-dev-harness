...
## 기본 자동화 직접 지원 범위
보일러플레이트의 기본 자동화·문서 템플릿이 직접 다루는 스택은 web frontend / API server / CLI / monorepo / Supabase 통합 / Flutter(Android·iOS) 6종이다. 그 외(iOS Swift / Android Kotlin / RN / ML / embedded / game / desktop)는 **ADR-031의 기본 범위 결정을 supersede하는 project ADR**을 발행하는 경로 (ADR-031#amend-1, ADR-059).
...
- [인터페이스 결정 책임 분배 + DESIGN.md 내용 계약 v2](docs/90-decisions/boilerplate/ADR-073-interface-and-design-content-v2.md) (DESIGN.md UI + ARCH 7-1~7-5 cross-surface enforcement, ADR-073 D8)
