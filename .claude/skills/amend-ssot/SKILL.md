...
change-set의 각 대상 절을 전파표에 대입해 «함께 볼 곳»과 «잔여 액션»을 산출한다. 전파표는 ADR-069 D3가 SSOT이며 여기에 재서술하지 않는다(#amend-1 행 포함 — 승인 UI·공용 컴포넌트·토큰 변경 시 재승인 판정: ADR-069#amend-1 · ADR-072 D5-5) — 그 절을 읽고 그대로 적용한다.
